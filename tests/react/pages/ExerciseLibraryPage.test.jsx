...
vi.mock('@/components/exerciseLibrary/ExerciseLibraryHero', () => ({ default: () => <div data-testid="hero" /> }));
vi.mock('@/utils/api', () => ({
  getExercises: vi.fn(),
}));
...
describe('ExerciseLibraryPage', () => {
  ...
  it('calls getExercises again when a filter is clicked', async () => {
    ...
    renderPage();
    await waitFor(() => expect(screen.queryByText('Loading exercises...')).not.toBeInTheDocument());
