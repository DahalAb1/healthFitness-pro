...
export function AuthProvider({ children }) {
  ...
  const [loading, setLoading] = useState(() => !!localStorage.getItem('hfp_token'));
  ...
  const [avatar, setAvatarState] = useState(() => localStorage.getItem('hfp_avatar') || null);
  ...
  return (
    <AuthContext.Provider value={{ token, user, loading, login, register, logout, avatar, setAvatar }}>
      {children}
